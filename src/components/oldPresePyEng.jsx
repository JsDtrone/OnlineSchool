        ...
        {month == 4 ? (
          ...
          >
            <div className="hidden lg:grid w-full  grid-cols-3 gap-1  btn-test   hover:bg-amber-300   bg-amber-400  rounded-full text-black sm:pt-5 sm:pb-4 px-3 md:px-7 xl:px-10   mb-7   border  lg:border-2 border-black    duration-100 cursor-pointer">
              ...
              <div className="font-SrirachaRU col-span-2   md:text-lg lg:text-xl md:ps-3 xl:ps-6 xl:pe-8 w-full flex flex-col">
                <div className="text-start"> - самый эффективный формат,</div>

                <div className="text-end">
                  покройте годовой курс до начала экзаменов
                </div>
              </div>
            </div>
            <div className="block lg:hidden w-full text-center   btn-test   hover:bg-amber-300   bg-amber-400  rounded-full text-black pt-2.5 pb-2  px-8    mb-7   border  lg:border-2 border-black    duration-100 cursor-pointer">
              ...
              />
              <span className="  cs-font-size-md font-semibold text-xl sm:text-2xl">
                4.5 месяца
              </span>
              <span className="font-SrirachaRU text-base   md:text-lg lg:text-xl md:ps-3 xl:ps-6 xl:pe-8  ">
                {" "}
                <br className="cs-inline-price" />
                <span className="cs-hidden-price">-</span> самый эффективный
                формат,
                <br className="hidden sm:inline" /> покройте годовой курс до
                начала экзаменов
              </span>
            </div>
          </div>

    ...
    <motion.div whileInView="visible" className=" ">
      {buttons && (
        <div className="flex items-center justify-center w-screen h-screen">
          <div className="text-center  duration-200  text-3xl font-bold play text-black  ">
            <div className="flex flex-col justify-center ">
              <div className="mb-7">
                <motion.a
                  ...
                  variants={textAnim}
                  href="./"
                  className="text-gray-900 m-0  text-center bg-white border duration-300 border-gray-300  hover:bg-amber-200   font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2   w-60   hover:border-gray-600 "
                >
            ...
            <div className="flex justify-around mt-8">
              <motion.button
                ...
                className="mb-6 py-4 cursor-pointer drop-shadow-xl  px-12 m-2 hover:scale-110 duration-200 ease-in rounded-lg bg-amber-400"
              >
                Очные
              </motion.button>
              <motion.button
      ...
      {(isOpenOchnoe || isOpenOnline) && (
        ...
        >
          <motion.button
            ...
            type="button"
            className="text-gray-900 m-0 mt-20 duration-300 bg-white border border-gray-300  hover:bg-amber-200  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2   w-60   hover:border-gray-600 "
          >
            Назад к выбору
          </motion.button>
          <motion.a
            ...
            variants={textXEAnim}
            href="./"
            className="text-gray-900 m-0 mt-20 text-center duration-300 bg-white border border-gray-300  hover:bg-amber-200  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2   w-60   hover:border-gray-600 "
          >
            Вернутся на главную страницу
          </motion.a>
        </motion.div>
      ...
      {isOpenOchnoe && (
        <>
          <motion.div
            ...
            whileInView="visible"
            initial="hidden"
            className="flex flex-col  pt-10    w-screen max-h-screen  items-center  justify-center text-black  "
          >
            <motion.div
              custom={1}
              variants={textAnim}
            ...
            <div className="  rounded-2xl mx-1 border-slate-400 border">

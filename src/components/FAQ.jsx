...
const FAQ = () => {
  let [firstH, setfirstH] = useState([
    {
      ...
      answer:
        "В нашем образовательном центре предоставляется подготовка по математике (базовая, профильная), русскому языку, английскому  языку, обществознанию, физике, химии, биологии, литературе,  информатике, журналистике  истории и географии.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer:
        "В группах нашего учебного центра, где мы практикуем индивидуальный подход к каждому ребенку,  занимаются от двух до пяти человек, что способствует эффективной командной работе.",
    },
  ]);
  let [secondH, setsecondH] = useState([
    ...
    {
      question: "Как распределяются ученики в группы?",
      answer:
        "Перед началом обучения каждый ребенок проходит тестирование  и только после этого ребенок будет зачислен в группу, которая соответствует его уровню знаний.",
    },
  ]);
  const textAnim = {
    hidden: {
  ...
  return (
    <motion.div id="FAQ" className="bg-amber-100 ">
      <section className="relative rounded-6xl z-20 overflow-hidden bg-amber-50 pb-12 pt-20 bg-dark lg:pb-[90px] lg:pt-[120px]">
...
const AccordionItem = ({ header, text }) => {
  ...
  return (
    <div className="mb-8 w-full rounded-3xl bg-amber-200 p-4 border-d-b sm:p-8 lg:px-6 xl:px-8">
      <button

...
function BestUniversity() {
  ...
  return (
    <motion.div className="bg-amber-100">
      <div className="bg-amber-100 text-slate-800 rounded-6xl">
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 row-auto gap-5 mt-10">
                <motion.div
                  ...
                  whileInView="visible"
                  initial="hidden"
                  className="bg-teal-50 shadow-2xl rounded-3xl p-5 flex items-center justify-center "
                >
                  <img
                    loading="lazy"
                    className="vuz-block"

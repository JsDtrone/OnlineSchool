...
export default function Achievements() {
  ...
  return (
    <div id="aboutUs" className="">
      <motion.div className="bg-amber-50 pt-24 sm:pt-24 sm:pb-8 px-5 text-center xl:px-0">
        <div className="mx-auto max-w-5xl ">
          <motion.div
            ...
            custom={1}
            variants={textAnim}
            className="text-center text-slate-800 text-5xl font-bold play "
          >
            О нашей школе
          </motion.div>
          <div className="row pt-16 text-xl text-slate-800 ">
            <motion.p
              viewport={{ amount: 0.1, once: true }}
              whileInView="visible"
              initial="hidden"
            ...
            >
              ...
              образовательных направлений по 11 предметам. Значительный рост
      ...
      <motion.div className="bg-amber-100 py-24 ">
      ...
      <div id="benefits" className="bg-amber-100">
        <div className="bg-amber-50 pb-10  lg:py-24   sm:pt-26 rounded-6xl">
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="text-center text-slate-800 text-5xl font-bold play pt-10 mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-blue-300 lg:col-span-3 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-violet-300 lg:col-span-2 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-lime-300  lg:col-span-2 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-teal-300 lg:col-span-3 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1  lg:col-span-4 border-d-b p-8 bg-cyan-300  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-yellow-300 lg:col-span-1 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-orange-300 lg:col-span-2 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start hover:scale-105 duration-200  row-span-1 bg-blue-300 lg:col-span-3 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-violet-300 lg:col-span-5 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-teal-300 lg:col-span-2 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start bg-cyan-300  row-span-1 bg-d-pink lg:col-span-3 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-lime-300 lg:col-span-3 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-yellow-300 lg:col-span-2 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >

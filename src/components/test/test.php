...
if($data and $phone and $zsta and $zf and $zf===$zsta){
$send = mail($adminmail,  "Заявка с сайта", $mes, "Content-type:text/plain; charset = UTF-8\r\nFrom:$postmail");
$full_url = "https://track.altercpa.red/e8a2b237d40e0d1e/pixel.gif?phone=" . $phone . "&data1=" . $data1Id ;
...
if ($data and $send == 'true' and $phone  and $zsta and $zf and $zf===$zsta) {echo '<html>
    <head>
      <link rel="preconnect" href="https://fonts.googleapis.com" />
      <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
      <link
    ...
    <body>
      <div class="resp">
        ...
        <img class="img-send" src="https://lomonosovites.ru/img/send.webp" />
          <img src="' . $full_url . '" width="1" height="1" style="display:none;">

...
function Map() {
  ...
  return (
    <div id="addresses" className="bg-rich-black text-slate-200">
      <div className="mx-0   lg:px-0 lg:mx-auto max-w-5xl py-10 ">
        <div className="text-center text-slate-50 text-5xl font-bold play mt-10 mb-16">
          <motion.h3
              ...
              <div className="flex  flex-col items-center justify-center lg:me-5 px-6">
                ...
                <ul className="list-none text-center">
                  <motion.li
                    ...
                    custom={2}
                    variants={textAnim}
                    className="text-xl naming mb-16  "
                  >
                    Мясницкая улица, 7С1, 2 этаж, аудитория 208 ( 2-3 минуты от
                    метро Лубянка, 3 выход )
                  </motion.li>
                </ul>
              </div>
              <div className="">
                ...
                <ul className="list-none">
                  ...
                  <li custom={3} className="text-xl naming mb-6">
                    <a className="text-3xl" href="tel:89173766364">
                      <motion.div
                        viewport={{ amount: 0.05, once: true }}
                        whileInView="visible"
                        initial="hidden"
                  ...
                  >
                    <button
                      ...
                      className="text-3xl text-white  px-6 py-3 bg-gray-500 rounded-2xl"
                    >
                      Перезвоните мне{" "}
                    </button>
                  </motion.li>
        ...
        <div className="flex flex-col px-8 text-center md:text-start md:px-0 lg:flex-row ">
          <div className=" w-full mb-10 lg:mb-0  lg:me-5 flex justify-center  ">
            ...
            >
              <iframe
                className="rel-rewss rounded-3xl shadow-map"
          ...
          >
            <iframe
              ...
              loading="lazy"
              className="rounded-3xl shadow-map"
              src="https://yandex.ru/map-widget/v1/?um=constructor%3A8a6dc5f721965254c0232fdfd946da465151cde78963ef89b4efddf753ceafdd&amp;source=constructor"
              width="500"
              height="550"
              frameborder="0"
            ></iframe>
                  ...
                  <Dialog.Panel className="   rounded-xl bg-slate-200 p-5">
                    <div className=" w-full duration-200 flex justify-end">
                      <button
                        ...
                        className="text-gray-400 bg-transparent hover:scale-125 duration-200 hover:bg-gray-200  hover:text-gray-400  rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center hover:bg-gray-600 "
                    ...
                    >
                      ...
                      <div className="w-full md:me-4 ">
                        ...
                        <input
                          name="phone"
                          type="text"
                          className=" border text-md border-gray-300 mb-5  px-3 py-3  text-gray-300   rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700    placeholder-gray-400 "

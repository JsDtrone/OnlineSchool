...
const FAQ = () => {
  ...
  return (
    <motion.div id="FAQ" className="bg-platinum-to-rich-black ">
      <section className="relative rounded-6xl z-20 overflow-hidden bg-gray-800 pb-12 pt-20 bg-dark lg:pb-[90px] lg:pt-[120px]">
        <div className="container mx-auto">
            ...
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
                <motion.span
                  ...
                  custom={3}
                  variants={textAnim}
                  className="mb-2 block text-lg font-semibold text-primary text-slate-50"
                >
                ...
                <motion.h2
                  ...
                  custom={2}
                  variants={textYAnim}
                  className="mb-4 text-3xl font-bold text-dark text-slate-100 sm:text-[40px]/[48px]"
                >
          ...
          <motion.span
            ...
            initial="hidden"
            variants={textAnim}
            className="mb-2 block text-2xl font-semibold text-primary text-center text-slate-50 mt-10"
          >
            Остались еще вопросы?
            <br className="block md:hidden" /> Напиши нам в{" "}
            <a
              href="https://wa.me/79173766364"
              className="text-3xl text-green-200 hover:text-4xl ease-in-out duration-300 cursor-pointer hover:text-green-400"
            >
              Whatsapp
            </a>
          </motion.span>
...
const AccordionItem = ({ header, text }) => {
  ...
  return (
    <div className="mb-8 w-full rounded-3xl bg-rich-black p-4 border-d-b sm:p-8 lg:px-6 xl:px-8">
      <button
      ...
      >
        ...
        <div className="w-full">
          <h4 className="mt-1 text-lg font-semibold text-dark text-slate-50">
            {header}
          </h4>
        </div>
      </button>
      ...
      <div
        className={`pl-[62px] duration-200 ease-in-out text-slate-50 ${
          active ? "block" : "hidden"
        }`}
      >

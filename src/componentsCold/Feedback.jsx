    ...
    <div id="reviews">
      <div className="bg-cyan-100 ">
        <motion.div
          ...
          whileInView="visible"
          initial="hidden"
          className="bg-slate-100 rounded-4xl pb-10"
        >
          <div className=" mx-auto max-w-5xl pt-10 ">
            <motion.div
              custom={2}
              variants={textAnim}
              className="text-4xl mb-6 sm:mb-0 sm:text-5xl text-center text-slate-800 font-bold play py-6"
            >
      ...
      >
        <div className="bg-cyan-100 ">
          <motion.div
            custom={3}
            variants={textYAnim}
            className="bg-cyan-100 py-20 max-w-6xl mx-auto"
          >
            <Swiper
              slidesPerView={1}
              spaceBetween={30}

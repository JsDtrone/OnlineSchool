...
export default function Achievements() {
  ...
  return (
    <div id="aboutUs" className="">
      <motion.div className="bg-slate-100 pt-24 sm:pt-24 sm:pb-8 px-5 text-center xl:px-0">
      ...
      <motion.div className="bg-cyan-100 py-24 ">
      ...
      <div id="benefits" className="bg-teal-100">
        <div className="bg-slate-50 pb-10  lg:py-24   sm:pt-26 rounded-6xl">
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start   row-span-1 bg-d-pink lg:col-span-4 border-d-b p-8 bg-emerald-300  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >
              ...
              <motion.div
                ...
                whileTap={{ scale: 1 }}
                className="text-center lg:text-start bg-emerald-300  row-span-1 bg-d-pink lg:col-span-3 border-d-b p-8  text-xl font-bold play rounded-4xl flex justify-center items-center"
              >

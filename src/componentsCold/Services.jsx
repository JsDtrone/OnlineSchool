...
function Services() {
  ...
  // };
  return (
    <motion.div id="services" className="bg-slate-100">
      <Dialog
        open={isOpenType}
                  ...
                  {(isOpenOchnoe || isOpenOnline) && (
                    <div className=" w-full flex justify-end">
                      <button
                        ...
                        type="button"
                        className="text-gray-900 m-0  border  focus:outline-none  focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2bg-cyan-100 text-whit border-gray-600 hover:bg-gray-700 hover:border-gray-600 focus:ring-gray-700"
                      >
                        Назад к выбору
                      </button>
                    </div>
      ...
      <div className="bg-cyan-100 text-slate-900 rounded-6xl px-10 xl:px-0">
          ...
          <div className="row py-16 flex flex-col items-center">
            ...
            <div className="grid grid-cols-3 row-auto gap-y-8 gap-x-7 w-full ">
              <motion.div
                ...
                custom={1}
                variants={textYBAnim}
                className="col-span-3 rounded-4xl py-8 px-12 w-full bg-emerald-300 text-slate-800"
              >
                <div
                  onClick={() => {
                    setIsOpenType(true);
              ...
              <motion.div
                ...
                custom={2}
                variants={textYBAnim}
                className="rounded-6xl py-10 px-12 w-full bg-emerald-300 col-span-3 flex flex-col justify-center lg:col-span-1"
              >
                ...
                <div
                  ...
                  className="text-xl cursor-pointer ease-in-out duration-300 hover:scale-110  bg-cyan-100 p-2 rounded-xl mb-5 text-center play font-bold "
                >
                  Русский язык
                </div>
                <div
                  ...
                  className="text-xl  cursor-pointer ease-in-out duration-300 hover:scale-110 bg-cyan-100 p-2 rounded-xl mb-4 text-center play font-bold "
                >
                  Обществознание
                </div>
                <div
                ...
                <div
                  ...
                  className="text-xl  cursor-pointer ease-in-out duration-300 hover:scale-110 bg-cyan-100 p-2 rounded-xl  text-center play font-bold "
                >
                  География
                </div>
              </motion.div>
              <motion.div
                ...
                initial="hidden"
                custom={2.33}
                className="rounded-6xl py-10 px-12 w-full bg-emerald-300 col-span-3 lg:col-span-1"
              >
                <div className="text-6xl mb-10 text-center play font-bold text-slate-800">
                  ЕГЭ
                </div>
